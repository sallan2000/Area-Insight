...
- Name: compare.spec.ts >> Compare page — postcode validation >> both postcodes invalid shows 'Postcodes not found' toast and does not call /api/assess
- Location: tests/compare.spec.ts:85:3
