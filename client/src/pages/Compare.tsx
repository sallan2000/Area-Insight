        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="flex justify-center gap-6 py-4 border-y">
              <FacebookShareButton url={comparisonUrl}>
                <FacebookIcon size={40} round />
              </FacebookShareButton>
              <TwitterShareButton url={comparisonUrl} title={`Comparing ${pc1} vs ${pc2} on ScoreMyStreet!`}>
                <TwitterIcon size={40} round />
              </TwitterShareButton>
              <LinkedinShareButton url={comparisonUrl}>
